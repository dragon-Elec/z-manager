...
<Dialog.Root bind:open={open}>
  <Dialog.Portal>
    ...
    <Dialog.Content class="fixed inset-0 m-auto z-50 w-full max-w-md h-fit rounded-2xl border border-base-content/10 bg-base-100/95 backdrop-blur-md p-6 shadow-lg outline-none">
      ...
      <div class="mt-6 flex justify-end gap-3">
        ...
        <button class="btn btn-warning" onclick={onConfirm}>Confirm</button>
      </div>
    </Dialog.Content>
  </Dialog.Portal>
</Dialog.Root>